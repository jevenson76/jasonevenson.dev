...
const SocialIcons = ({ className = "", size = 24 }) => {
  const iconClass = `w-${size} h-${size} transition-all duration-300 hover:scale-110 hover:opacity-80`;
  ...
  return (
    <div className={`flex items-center space-x-6 ${className}`}>
      ...
      {/* GitHub */}
      <a 
        href="https://github.com/jevenson76" 
        target="_blank" 
        rel="noopener noreferrer"
      ...
      {/* Email */}
      <a 
        href="mailto:jason@jasonevenson.dev" 
      ...
      {/* YouTube */}
      <a 
        href="https://youtube.com/@jasonevenson" 
        target="_blank" 
        rel="noopener noreferrer"
      ...
      {/* Medium */}
      <a 
        href="https://medium.com/@jasonevenson" 
        target="_blank" 
        rel="noopener noreferrer"
